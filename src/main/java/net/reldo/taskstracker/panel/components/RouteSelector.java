...
/**
 * UI component for selecting and managing routes.
 * Displays a dropdown to select the active route and a button to manage routes.
 */
public class RouteSelector extends JPanel
{
	...
	/**
	 * Updates the dropdown with the given routes and selects the active route.
	 */
	...
	/**
	 * Gets the currently selected route name.
	 * Returns null if no route is selected (i.e., "(None)" is selected).
	 */
	...
	/**
	 * Adds a listener for route selection changes.
	 * The listener will NOT be called during programmatic updates via setRoutes().
	 */
	...
	/**
	 * Adds a listener for the manage button click.
	 */
	...
	/**
	 * Returns whether any route is currently selected.
	 */
	public boolean hasRouteSelected()
	{
		return getSelectedRouteName() != null;
	}
}
